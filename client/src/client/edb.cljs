...
(def insert-collection (wrap-entity-db-mutate (:insert-collection-many dbal)))
(def append-collection (wrap-entity-db-mutate (:append-collection-many dbal)))
...
(def remove-collection (wrap-entity-db-mutate (:remove-collection-many dbal)))
...
(def get-collection (wrap-entity-db-get (:get-collection-many dbal)))
...
(def get-collection-meta (wrap-entity-db-get (:get-collection-many-meta dbal)))
